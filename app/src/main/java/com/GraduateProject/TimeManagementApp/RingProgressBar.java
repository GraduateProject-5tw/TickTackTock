...
public class RingProgressBar extends View{
    ...
    protected  void onDraw(Canvas canvas) {
        ...
        if (!isInit) {
            ...
            //圓環的顏色
            roundColor = mTypedArray .getColor(R.styleable.RingProgressBar_roundColor, Color.rgb(250,250,255));
            //圓環進度條的顏色
            roundProgressColor = mTypedArray.getColor(R.styleable.RingProgressBar_roundProgressColor, Color.rgb(207,211,252));
