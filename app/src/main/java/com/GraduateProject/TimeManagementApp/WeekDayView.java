...
//            ViewCompat.postInvalidateOnAnimation(WeekNoHeaderView.this);
    ...
    public WeekDayView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            mTextSize = a.getDimensionPixelSize(R.styleable.WeekView_textsizee, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, mTextSize, context.getResources().getDisplayMetrics()));
