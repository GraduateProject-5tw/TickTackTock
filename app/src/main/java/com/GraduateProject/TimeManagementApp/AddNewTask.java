...
public class AddNewTask extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if(bundle != null){
            ...
            assert task != null;
            if(task.length()>0)
                Save.setTextColor(ContextCompat.getColor(getContext(), R.color.design_default_color_on_primary));
        }

        db = new DBToDoHelper(getActivity());
        db.openDatabase();
        ...
        newTaskText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if(s.toString().equals("")){
                    ...
                    Save.setTextColor(ContextCompat.getColor(getContext(), R.color.design_default_color_secondary_variant));
                }
            }
